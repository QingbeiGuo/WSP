...
class resnet(_fasterRCNN):
  def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
    ...
    self.model_path = '/data/qingbeiguo/work/faster-rcnn.pytorch-pytorch-1.0/faster-rcnn.pytorch-pytorch-1.0-1-res50-voc-600-40/lib/model/faster_rcnn/pretrained_model/model_training_m40.pth'
